...
def callback(data):
	...
	if data.song == data.Star_Wars:
		...
		music_score.score=[MusicalTones('la',4, 375),
				MusicalTones('mi',4, 375),
				MusicalTones('fa#',4, 125),
				MusicalTones('sol#',4, 125),
				MusicalTones('la',4, 125),
				MusicalTones('mi',4, 250),
				MusicalTones('silence',4, 125),
				MusicalTones('si',4, 375),
				MusicalTones('mi',4, 375),
				MusicalTones('fa#',4, 125),
				MusicalTones('sol#',4, 125),
				MusicalTones('la',4, 125),
				MusicalTones('si',4, 250),
				MusicalTones('silence',4, 125),
				MusicalTones('la',4, 375),
				MusicalTones('mi',4, 375),
				MusicalTones('fa#',4, 125),
				MusicalTones('sol#',4, 125),
				MusicalTones('la',4, 125),
				MusicalTones('mi',4, 250),
				MusicalTones('silence',4, 125),
				MusicalTones('do#',5, 375),
				MusicalTones('la',4, 375),
				MusicalTones('sol#',4, 125),
				MusicalTones('fa#',4, 125),
				MusicalTones('sol#',4, 125),
				MusicalTones('silence', 4, 75),
				MusicalTones('mi', 4, 75),
                                MusicalTones('mi', 5, 1250),
                                MusicalTones('re', 5, 125),
                                MusicalTones('do#', 5, 125),
                                MusicalTones('si', 4, 500),
                                MusicalTones('do#', 5, 125),
                                MusicalTones('si', 4, 125),
                                MusicalTones('la', 4, 500),				
				MusicalTones('silence',4, 375),
                                MusicalTones('mi', 4, 75),
                                MusicalTones('mi', 5, 1250),
                                MusicalTones('re', 5, 125),
                                MusicalTones('do#', 5, 125),
